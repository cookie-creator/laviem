...
@section('content')
    ...
    <h3 class="pb-3 pt-3 px-3">Create notification</h3>
    <div class="row pb-2 px-3 mb-5">

        <div class="col-12 col-md-6">
            <form  method="POST" action="{{ route('notification.store') }}" class="needs-validation" novalidate="">
            @csrf
                <input type="hidden" class="form-control" id="private" name="private" value="0" placeholder="" required="">
                <div class="col-12">
